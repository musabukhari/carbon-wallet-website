      ...
      <div className="mx-auto max-w-7xl px-6 py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/80">
              <li><Link to="/about" className="hover:text-leaf" data-testid="footer-about">About Us</Link></li>
        ...
        <div className="mt-8 border-t border-white/10 pt-6 text-sm text-white/70 flex items-center justify-between">
